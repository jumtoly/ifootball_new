...
//	private int screenHeight = ProductPhotoSpecificationActivity.screenHeight;
//	private int screenWidth = ProductPhotoSpecificationActivity.screenWidth;
	private int screenHeight = 0;
	private int screenWidth = 0;
	private int heightTitleAndThumb = 144;
	private boolean isSetupPhoto = false;
	...
	public GalleryImageView(Context context, AttributeSet attrs, int imageWidth, int imageHeight) {
		super(context, attrs);
		this.mContext = context;
		this.imageHeight = imageHeight;
		this.imageWidth = imageWidth;
	...
	public void setImageBitmap(Bitmap bitmap) {
		...
		arithScaleRate();
		zoomTo(mScaleRate, bitmap.getWidth() / 2, bitmap.getHeight() / 2);
		isSetupPhoto = true;
		invalidate();
	...
	public void layoutToCenter() {
		...
		float fill_height = screenHeight - DisplayUtil.getPxByDp(mContext, heightTitleAndThumb) - height;
	...
	protected void postTranslateDurHorizontal(final float dx, final float durationMs) {
		_dx = 0.0f;
